...
download_sample(sample_name="pbmc3k", sample_dir=file.path(PIPESTANCE_BASE_PATH, 'pbmc3k'), host="https://s3-us-west-2.amazonaws.com/10x.files/samples/cell/", lite=F)
download_sample(sample_name="pbmc6k", sample_dir=file.path(PIPESTANCE_BASE_PATH, 'pbmc6k'), host="https://s3-us-west-2.amazonaws.com/10x.files/samples/cell/", lite=F)
