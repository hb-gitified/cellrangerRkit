...
\hlstd{km_res} \hlkwb{<-} \hlstd{analysis_results}\hlopt{$}\hlstd{clustering} \hlcom{# load pre-computed kmeans results}
\hlstd{clu_res} \hlkwb{<-} \hlkwd{sapply}\hlstd{(n_clu,} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{) km_res[[}\hlkwd{paste}\hlstd{(}\hlstr{"kmeans"}\hlstd{,x,}\hlstr{"clusters"}\hlstd{,}\hlkwc{sep}\hlstd{=}\hlstr{"_"}\hlstd{)]]}\hlopt{$}\hlstd{Cluster)}
...
\hlstd{cluster_result} \hlkwb{<-} \hlstd{analysis_results}\hlopt{$}\hlstd{clustering[[}\hlkwd{paste}\hlstd{(}\hlstr{"kmeans"}\hlstd{, example_K,}\hlstr{"clusters"}\hlstd{,}\hlkwc{sep}\hlstd{=}\hlstr{"_"}\hlstd{)]]}
